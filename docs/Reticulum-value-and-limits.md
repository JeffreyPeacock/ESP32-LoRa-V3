...
a VPN or cellular link carries IP just the same.

(A ham/AREDN network can too, but Part 97 constrains what may be sent over it.
See `aredn-as-a-transport.md` — reference only; nothing here plans to use it.)
